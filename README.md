...
Full diagram: [`claudianShield/docs/architecture.puml`](claudianShield/docs/architecture.puml)  
Bootstrap sequence: [`claudianShield/docs/sequence-bootstrap.puml`](claudianShield/docs/sequence-bootstrap.puml)
...
cd clawdianShield/claudianShield
...
| --- | --- | --- |
| `claudianShield/collectors/file_observer.py` | Host-side watchdog PollingObserver on bind-mounted victim state dir | live |
| `claudianShield/collectors/log_observer.py` | Host-side log tailer on bind-mounted `/var/log/auth.log`; regex-classifies pam_unix events | live |
| `claudianShield/collectors/run.py` | Convenience launcher: start both observers, share stop event, write to `evidence/` | live |
| `claudianShield/collectors/correlation.py` | Cross-host adjacency from `details.source_host` | utility |
| `claudianShield/collectors/normalizer.py` | Dict -> NormalizedEvent boundary helper | utility |
| `claudianShield/collectors/file_events.py` | sha256 snapshot/diff helpers used by file_observer | utility |
