...
![ClawdianShield SOC Console - Overview showing 138 ingested events, severity timeseries, event type distribution, collector feeds, and top mutated paths](docs/dashboard-screenshot.png)
